...
function SignInInner({ isPlatform }: { isPlatform: boolean }) {
  ...
  return (
    ...
    <SplitShell
      ...
      quoteHtml={
        isPlatform
          ? "Software for<br/><em>cleaning<br/>companies.</em>"
          : "Run the whole<br/>operation <em>from<br/>one place.</em>"
      }
      quoteSub={
        isPlatform
...
export default function SignInForm({ isPlatform }: { isPlatform: boolean }) {
  return (
    <Suspense fallback={null}>
      <SignInInner isPlatform={isPlatform} />
    </Suspense>
  );
}
