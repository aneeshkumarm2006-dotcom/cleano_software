  ...
  return (
    <SectionCard
      ...
      {kitTemplates.length === 0 ? (
        <p className="text-sm text-[#008C9C]/60">No kit templates yet.</p>
      ) : (
              ...
              <div className="flex-1">
                ...
                <div className="mt-2 flex flex-wrap gap-1">
                  {kit.items.map((it) => (
                    <span
                      key={it.id}
                      className="text-xs bg-[#008C9C]/10 text-[#008C9C] px-2 py-0.5 rounded-full">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            {draft.items.length === 0 && (
              <p className="text-xs text-[#008C9C]/60">No products added.</p>
            )}
            <div className="space-y-2">
