...
export default function ContactDetailView({ contact: c, propertyDefs }: { contact: ContactDetail; propertyDefs: PropertyDef[] }) {
  ...
  return (
    <div className="admin-font">
      <button className="jdetail-back" onClick={() => router.push("/admin/contacts")}><ArrowLeft size={14} /> Back to Contacts</button>
    ...
    <div className="stack-16">
      <div className="dcard" style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 16, flexWrap: "wrap" }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button className="btn btn-primary btn-sm" onClick={() => router.push(`/admin/contacts/duplicates?focus=${c.id}`)}>Open merge tool →</button>
        </div>
      </div>
